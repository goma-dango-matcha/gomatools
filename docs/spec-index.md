...
| 34 | [money-brand-review-spec.md](money-brand-review-spec.md) | Version1.0 | お金カテゴリのブランド改善完了後レビュー方針 |
| 35 | [health-brand-review-spec.md](health-brand-review-spec.md) | Version1.0 | 健康カテゴリのブランド改善完了後レビュー方針 |
| 36 | [learning-brand-review-spec.md](learning-brand-review-spec.md) | Version1.0 | 学習カテゴリのブランド改善完了後レビュー方針 |
| 37 | [work-text-brand-review-spec.md](work-text-brand-review-spec.md) | Version1.0 | 仕事・テキストカテゴリのブランド改善完了後レビュー方針 |
| 38 | [convenience-life-brand-review-spec.md](convenience-life-brand-review-spec.md) | Version1.0 | 便利ツール・生活カテゴリのブランド改善完了後レビュー方針・再レビュー結果 |
...
| 47 | [character-byte-difference-spec.md](character-byte-difference-spec.md) | Version1.0 | 「文字数とバイト数は何が違う？」の役割・UTF-8例・文字数実装・一次仕様・回遊・SEO・公開条件を定める個別実装仕様 |
